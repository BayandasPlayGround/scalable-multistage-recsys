...
_SETTINGS_TO_CONFIG_FIELDS = {
    ...
    "blair_state_repair_enabled": "blair_state_repair_enabled",
    "blair_promotion_min_recall_at_100": "blair_promotion_min_recall_at_100",
    ...
    "popularity_backfill_k": "popularity_backfill_k",
    "category_backfill_enabled": "category_backfill_enabled",
    "category_backfill_global_reserve_fraction": "category_backfill_global_reserve_fraction",
    "cold_start_context_global_reserve_fraction": "cold_start_context_global_reserve_fraction",
    ...
    "candidate_source_weight_cooccurrence": "candidate_source_weight_cooccurrence",
    "candidate_source_weight_latent_cf": "candidate_source_weight_latent_cf",
    "candidate_source_weight_content_based": "candidate_source_weight_content_based",
    "candidate_source_weight_two_tower": "candidate_source_weight_two_tower",
    "candidate_source_weight_popularity": "candidate_source_weight_popularity",
    "candidate_quota_cooccurrence": "candidate_quota_cooccurrence",
    "candidate_quota_latent_cf": "candidate_quota_latent_cf",
    "candidate_quota_content_based": "candidate_quota_content_based",
    "candidate_quota_popularity": "candidate_quota_popularity",
    "candidate_quota_neural_cooccurrence": "candidate_quota_neural_cooccurrence",
    "candidate_quota_neural_latent_cf": "candidate_quota_neural_latent_cf",
    "candidate_quota_neural_content_based": "candidate_quota_neural_content_based",
    "candidate_quota_neural_two_tower": "candidate_quota_neural_two_tower",
    "candidate_quota_neural_popularity": "candidate_quota_neural_popularity",
    ...
    "ranker_label_weighting_enabled": "ranker_label_weighting_enabled",
    "ranker_positive_rating5_weight": "ranker_positive_rating5_weight",
    "ranker_verified_positive_weight": "ranker_verified_positive_weight",
    "ranker_helpful_positive_weight": "ranker_helpful_positive_weight",
    "ranker_recent_positive_weight": "ranker_recent_positive_weight",
    "ranker_recent_positive_days": "ranker_recent_positive_days",
...
_PROFILE_CONTROLLED_FIELDS = {
    ...
    "category_backfill_global_reserve_fraction",
    "cold_start_context_global_reserve_fraction",
    "candidate_source_weight_cooccurrence",
    "candidate_source_weight_latent_cf",
    "candidate_source_weight_content_based",
    "candidate_source_weight_two_tower",
    "candidate_source_weight_popularity",
    "candidate_quota_cooccurrence",
    "candidate_quota_latent_cf",
    "candidate_quota_content_based",
    "candidate_quota_popularity",
    "candidate_quota_neural_cooccurrence",
    "candidate_quota_neural_latent_cf",
    "candidate_quota_neural_content_based",
    "candidate_quota_neural_two_tower",
    "candidate_quota_neural_popularity",
    ...
    metric_files = sorted(
        {
            ...
            *(eval_dir / name for name in [
                ...
                "candidate_source_quota_diagnostics.csv",
                ...
                "ranker_demotion_diagnostics.csv",
                "ranker_demotion_summary.csv",
                "ranker_feature_ablation_metrics.csv",
...
def pipeline_config_from_settings(settings: AppSettings) -> core.PipelineConfig:
    ...
    config = core.PipelineConfig(
        ...
        blair_state_repair_enabled=settings.retrieval.blair_state_repair_enabled,
        blair_promotion_min_recall_at_100=settings.retrieval.blair_promotion_min_recall_at_100,
        ...
        popularity_backfill_k=settings.retrieval.popularity_backfill_k,
        category_backfill_enabled=settings.retrieval.category_backfill_enabled,
        category_backfill_global_reserve_fraction=settings.retrieval.category_backfill_global_reserve_fraction,
        cold_start_context_global_reserve_fraction=settings.retrieval.cold_start_context_global_reserve_fraction,
        ...
        candidate_source_weight_cooccurrence=settings.retrieval.candidate_source_weight_cooccurrence,
        candidate_source_weight_latent_cf=settings.retrieval.candidate_source_weight_latent_cf,
        candidate_source_weight_content_based=settings.retrieval.candidate_source_weight_content_based,
        candidate_source_weight_two_tower=settings.retrieval.candidate_source_weight_two_tower,
        candidate_source_weight_popularity=settings.retrieval.candidate_source_weight_popularity,
        candidate_quota_cooccurrence=settings.retrieval.candidate_quota_cooccurrence,
        candidate_quota_latent_cf=settings.retrieval.candidate_quota_latent_cf,
        candidate_quota_content_based=settings.retrieval.candidate_quota_content_based,
        candidate_quota_popularity=settings.retrieval.candidate_quota_popularity,
        candidate_quota_neural_cooccurrence=settings.retrieval.candidate_quota_neural_cooccurrence,
        candidate_quota_neural_latent_cf=settings.retrieval.candidate_quota_neural_latent_cf,
        candidate_quota_neural_content_based=settings.retrieval.candidate_quota_neural_content_based,
        candidate_quota_neural_two_tower=settings.retrieval.candidate_quota_neural_two_tower,
        candidate_quota_neural_popularity=settings.retrieval.candidate_quota_neural_popularity,
        ...
        ranker_label_weighting_enabled=settings.ranking.ranker_label_weighting_enabled,
        ranker_positive_rating5_weight=settings.ranking.ranker_positive_rating5_weight,
        ranker_verified_positive_weight=settings.ranking.ranker_verified_positive_weight,
        ranker_helpful_positive_weight=settings.ranking.ranker_helpful_positive_weight,
        ranker_recent_positive_weight=settings.ranking.ranker_recent_positive_weight,
        ranker_recent_positive_days=settings.ranking.ranker_recent_positive_days,
        ...
        xgb_early_stopping_rounds=settings.ranking.xgb_early_stopping_rounds,
    )
