...
from amazon_recsys.application.bundles import BundleExportService
...
class Container:
    ...
    bundle_export_service: BundleExportService
...
def build_container(settings: AppSettings | None = None) -> Container:
    ...
    mlflow_tracker = MLflowTracker(resolved_settings)
    monitoring_service = MonitoringService(
    ...
    return Container(
        ...
        bundle_export_service=bundle_export_service,
